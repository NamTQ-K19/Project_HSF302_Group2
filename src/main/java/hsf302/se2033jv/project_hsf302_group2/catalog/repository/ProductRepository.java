package hsf302.se2033jv.project_hsf302_group2.catalog.repository;
...
/**
 * Repository for catalog-related product queries.
 * ISP: exposes only methods the catalog module needs.
 */
@Repository
