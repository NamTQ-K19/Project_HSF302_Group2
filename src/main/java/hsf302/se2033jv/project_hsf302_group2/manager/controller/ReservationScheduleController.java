...
public class ReservationScheduleController {
    ...
    public String showSchedule(
        ...
        ReservationStatsResponse stats = reservationScheduleService.getStatsAll();
    ...
    public String filterReservations(
        ...
        if (filter.getFromDate() != null && filter.getToDate() != null
            ...
            ReservationStatsResponse stats = (filter.getFromDate() != null && filter.getToDate() != null)
                    ? reservationScheduleService.getStats(filter.getFromDate(), filter.getToDate())
                    : reservationScheduleService.getStatsAll();
